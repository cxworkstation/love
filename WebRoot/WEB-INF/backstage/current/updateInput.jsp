...
table .floatLeft{float:left; }
 ...
 <form action="<%=basePath%>backstage/current/update" method="post" id="myform" name="myform">
         <table>
         <tr>
  ...
  <td colspan="2">
	...
	<input type="button"  onclick="goback('<%=basePath%>backstage/current/index');" value="返回" >
	</div>
