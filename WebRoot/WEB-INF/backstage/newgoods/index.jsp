...
<tr>
 <td height="26">
  ...
  <td align="center" background="<%=basePath %>imgs/backstage/wbg.gif">
     <a href="javascript:openWin('<%=basePath %>backstage/newgoods/addInput');" class="coolbg np">添加新品</a>
 </td>
 </tr>
</table>
</td>
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="<%=basePath %>imgs/backstage/wbg.gif">&nbsp;新品上市列表</td>
</tr>
...
<td align="center">${attr}</td>
	...
	<td align="center">
	<a href="javascript:openWin('<%=basePath %>backstage/newgoods/updateInput?id=${list1[0]}');">编辑</a> |
	<a href="javascript:del('<%=basePath %>backstage/newgoods/delete?id=${list1[0]}');">删除</a> | 
	<a href="javascript:openWin('<%=basePath %>backstage/newgoods/remarkInput?id=${list1[0]}');">备注</a> 
	</td>
	</tr>
   </c:forEach>
...
<td height="28" colspan="3" align="left">
	...
	<a href="javascript:bulkdel('<%=basePath %>backstage/newgoods/delBatch')" class="coolbg">&nbsp;删除&nbsp;</a>
</td>
<td colspan="7" valign="top">
  <!--  搜索表单  -->
<form name='from1' action='<%=basePath %>backstage/newgoods/search' method='post'>
